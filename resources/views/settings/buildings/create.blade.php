                                ...
                                <form method="post" action="{{ route('buildings.store') }}">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="name" type="text" placeholder="Enter your office" name="name" />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="small mb-1">Lantai</label>
                                            <input class="form-control" id="floor" type="text" placeholder="Enter your office" name="floor" />
                                        </div>
                                    </div>
                                    <!-- Submit button-->
